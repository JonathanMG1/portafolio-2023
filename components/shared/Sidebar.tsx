...
const Sidebar = ({ showMenu, onClose }: SidebarProps) => {
  return (
    <>
      <aside
        className={cn(
          'fixed top-0 lg:left-0 bg-dark w-[70vw] md:w-[30vw] lg:w-[20vw] xl:w-[14vw] h-full border-r border-gray-500/30 transition-all duration-300 ease-in-out z-50',
      ...
      >
        <section className="p-8 border-b border-gray-500/30">
          ...
          <h3 className=" text-gray-500 font-light">Desarrollador Web</h3>
        </section>
        <section>
          <MainMenu />
        </section>
